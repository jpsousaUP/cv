...
- **Machine Learning Libraries:** PyTorch, Hugging Face, TensorFlow, stable-baselines  
- **Computer Vision:** OpenCV, Ultralytics  
- **Robotics:** ROS, MCAP, Foxglove  
...
- **António Luís Paiva, 2024:** *Application of Convolutional Neural Networks for Monitoring Laser Melting Deposition Processes*  
  - FEUP | Ongoing | Developing a CNN-based model for in-situ monitoring of laser-based manufacturing.

- **José Pedro Ferreira, 2024:** *Generative Multimodal Learning for In-situ Monitoring in Direct Energy Deposition*  
  - FEUP | Ongoing | Applying generative AI models for multimodal analysis in additive manufacturing.

- **António Silva, 2025:** *Computer Vision and AI for Monitoring the Melt Pool*  
